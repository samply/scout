...
fn PatientTable() -> Element {
    ...
    {
        rsx! { "Server functions are unavailable in web-only builds." }
    }
}
                ...
                div { class: "max-w-4xl mx-auto px-4",
                        ...
                        .circular_tuple_windows()
                    {
                        match entry.resource {
                            Resource::Encounter(ref encounter) => {
                                rsx! {
                            ...
                            Resource::Condition(ref condition) => {
                                rsx! {
                                    div {
                            ...
                            Resource::Procedure(ref procedure) => {
                                rsx! {
                                    div {
                                        class: "my-3 p-2 border rounded",
                            ...
                            Resource::Observation(ref observation) => {
                                rsx! {
                                    div { class: "my-3 p-2 border rounded border-gray-300 bg-gray-50",
                                        p {
